Public Class Form12
    ...
    Private Sub ModuloComboBox_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ModuloComboBox.SelectedIndexChanged

        If ModuloComboBox.Text <> "" Then
    ...
    Private Sub RadioButton1_CheckedChanged(sender As Object, e As EventArgs) Handles RadioButton1.CheckedChanged
        If RadioButton1.Checked = True Then
            ...
            Label8.Visible = True
            ModuloComboBox.SelectedItem = Nothing
        ...
        Else
            ...
            Else
                If MsgBox("Deseja inserir a nota? ", MsgBoxStyle.Information + MsgBoxStyle.YesNo, "Escola") = MsgBoxResult.Yes Then
                    Try
                        var1.Insert(TurmaComboBox.Text, ModuloComboBox.Text)
